export default function radios_am(){
   ...
   function habilitar_controle(){
    ...
    controle3.classList.remove('esconde');
    controle4.classList.add('esconde');
    controle5.classList.add('esconde');
}

   botao_radio_am.addEventListener('click',habilitar_controle);
    ...
    var nome_estacao_radio = Object.keys(radio_am);
    var frenquencia_radio_am = Object.values(radio_am);
 
    
    
    
    var sintonizacao_radio_am = document.querySelector('#texto_radio_am');
    
    
    
    function muda_estacao(){
        var canal_radio_am = document.querySelector('audio').src = frenquencia_radio_am[sintonizacao_radio_am.value];
     
       
        /*nome da radio*/
        var nome_radio_am = document.querySelector('#nome_radio_am');
        
        
        nome_radio_am.value = nome_estacao_radio[sintonizacao_radio_am.value];
    ...
    sintonizacao_radio_am.addEventListener('click',muda_estacao);
